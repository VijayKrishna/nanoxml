...
//          }
            ...
            if ((ch == '_') || (ch == ':') || (ch == '-') || (ch == '.')
                    ...
                    || ((ch >= 'A') && (ch <= 'Z'))
                    || ((ch >= '0') && (ch <= '9')) || (ch > '\u007E')) {
            	//FIXME#4: toLowerCase bug #2
//                result.append(Character.toLowerCase(ch));
            	// FIXME#5: lowerupper interleave
//            	result.append(Character.toLowerCase(ch));
//              result.append(ch);
                result.append(ch);
            } else {
        ...
        throws IOException
    {
        ...
        // FIXME#2: XML Util, Scan String Bug
//        return result.toString() + "scanString_bug";
        return result.toString();
    }
